...
class FileUpload {
	...
	private $allowtype = array ("doc", "docx", "xls", "xlsx", "ppt", "pptx", "txt"); // 设置限制上传文件的类型
	...
	public function getFileName() {
		return iconv('gb2312','utf-8',$this->newFileName);
	}
	...
	private function getError() {
		$str = "上传文件<font color='red'>".iconv('gb2312','utf-8',$this->originName)."</font>时出错 : ";
	...
	private function setFiles($name = "", $tmp_name = "", $size = 0, $error = 0) {
		...
		if ($error)
			return false;
		$this->setOption ( 'originName', iconv('utf-8','gb2312',$name));
